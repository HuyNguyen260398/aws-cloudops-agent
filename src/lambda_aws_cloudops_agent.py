"""
AWS CloudOps Agent - Lambda optimized version
Serverless-friendly version without rich console dependencies
"""
import logging
...
class LambdaAwsCloudOpsAgent:
    def __init__(self, aws_profile: str = "default"):
        ...
        logger.info("AWS CloudOps Agent initialized for Lambda")
    ...
    def _get_system_prompt(self) -> str:
        ...
        Note: You are running in a serverless environment, so focus on providing 
        informative responses without requiring interactive elements.
        """
